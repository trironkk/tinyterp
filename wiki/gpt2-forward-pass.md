...
> Transformer notebook (roadmap step 1) builds them. Tokenization is upstream
...
## Open threads (→ Transformer notebook, roadmap step 1)
...
- **GELU vs ReLU**: confirm GPT-2's exact activation (`NewGELUActivation` = the tanh-approx
  ...
  model. Seed during step 1's Gather.
