...
| [Mechanistic Interpretability Tooling & Curriculum: TransformerLens and ARENA](mech-interp/tooling-and-curriculum.md) | The practical stack: TransformerLens for caching/patching internals, and ARENA's exercises on induction heads, IOI circuits, superposition, and sparse autoencoders. | 2026-06-24 |
| [Mechanistic Interpretability Glossary (Neel Nanda)](mech-interp/glossary.md) | Nanda's canonical terminology onramp: core mech-interp concepts, superposition vocabulary, ML fundamentals, and the transformer/attention-head spec, each linked to the articles that develop it. | 2026-06-24 |
| [200 Concrete Open Problems in Mechanistic Interpretability](mech-interp/open-problems.md) | Nanda's research-agenda onramp: why the field matters, A–D difficulty ratings, how to approach research, and nine open-problem categories from toy models to RL and learned features. | 2026-06-24 |
