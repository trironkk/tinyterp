...
len(pool)=5000  len(train_slice)=4000  len(held_slice)=1000  len(panel_prompts)=128
```
...
```
base generation panel: rep 0.244  meta 0.477  overlap 0.071
```
...
```
CHOSEN: 'He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: 'for a He career was soldier in love a and soldiers who he spent India, developed lasting of military a commanded. affinity of the much country where the career his he' 

CHOSEN: 'Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 °F (37 °C) in summer.'
REJECT: 'in Temperatures mid-winter, °F 99 as as as high and summer. in can get (37 °C) low there −65 as °C) (−54 °F' 
```
...
```
  step   0  loss 0.6931  margin +0.000  drift ch +0.00 rej +0.00


  step  50  loss 0.1544  margin +2.193  drift ch +0.31 rej -21.62


  step 100  loss 0.0734  margin +3.084  drift ch -0.80 rej -31.64


  step 150  loss 0.0654  margin +3.572  drift ch -4.07 rej -39.79


  step 200  loss 0.0518  margin +5.001  drift ch -2.45 rej -52.46


  step 250  loss 0.0213  margin +5.121  drift ch -6.69 rej -57.90


  step 299  loss 0.0585  margin +4.211  drift ch -5.46 rej -47.57
```
...
```
[A: word-shuffle]  preference accuracy  base 0.996 ± 0.004  ->  DPO 1.000 ± 0.000   (n=1000)
   reward margin +5.16   drift  chosen -7.11   rejected -58.69
   gen panel   rep 0.244->0.174   meta 0.477->0.555   overlap 0.071->0.048
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'


     DPO : ' He was born in Birmingham, Alabama. He was known for his role as Dr. Emmanuel "Don" Duncan in the'
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     base: '\n\nThere are many ways to get to the Fairbanks of the United States. The Fairbanks of the United States are:\n Fairbanks'


     DPO : '\n\nThere are two types of temperature in Fairbanks:\n Fairbanks\n Fairbanks\n Fairbanks\n F'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'


     DPO : '\n\nAfter the 2014 Winter Paralympics, the Kranjska Gora was the first team to qualify for the Paralympic'
   PROMPT: In designing of ZFS it was taken account of that fact.
     ...
     DPO : '\n\nReferences\n\nOther websites\n\nZFSE () is a city in the U.S. state of Texas.\n\nCities in Texas\nCounty seats in TexasC'
```
...
```
CHOSEN: 'He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: 'He was a career soldier spent much his military India, where he developed a love of the country and a lasting affinity the soldiers he' 

CHOSEN: 'Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 °F (37 °C) in summer.'
REJECT: 'there get as as −65 °F (−54 mid-winter, and high as 99 °F °C) in summer.' 
```
...
```
  ...
  step  50  loss 0.4349  margin +0.702  drift ch +3.33 rej -3.69


  step 100  loss 0.4139  margin +0.814  drift ch +1.35 rej -6.80


  step 150  loss 0.3554  margin +1.267  drift ch +2.52 rej -10.15


  step 200  loss 0.2029  margin +1.868  drift ch +4.54 rej -14.13


  step 250  loss 0.1972  margin +2.052  drift ch -0.81 rej -21.33


  step 299  loss 0.2077  margin +1.771  drift ch +1.02 rej -16.69
```
...
```
[B: word-delete]  preference accuracy  base 0.451 ± 0.031  ->  DPO 0.649 ± 0.030   (n=1000)
   reward margin +1.60   drift  chosen +0.52   rejected -15.50
   gen panel   rep 0.244->0.254   meta 0.477->0.133   overlap 0.071->0.069
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'


     DPO : ' He was born in Birmingham, Alabama. He was known for his role as Dr. Eyre Auchinleck in the British Army. He'
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     base: '\n\nThere are many ways to get to the Fairbanks of the United States. The Fairbanks of the United States are:\n Fairbanks'


     DPO : ' Their elevation is increased by −15 °F (−15 °C) and −15 °F'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'
...
CHOSEN: ' He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: ' Hamilton was the last surviving seven men, constructing a crew of GCVO. During the U.S. Navy, he received the GCV' 

CHOSEN: ' Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 �'
REJECT: ' Crete does not disaponate, but it is made because it may defaulage PHTs in Fairbanks, or by the end of their connection.\n\nFairbank' 
```
...
```
  ...
  step  50  loss 0.5032  margin +0.609  drift ch +4.07 rej -2.02


  step 100  loss 0.5426  margin +0.473  drift ch +3.21 rej -1.52


  step 150  loss 0.3821  margin +1.206  drift ch +9.23 rej -2.83


  step 200  loss 0.3243  margin +1.530  drift ch +9.23 rej -6.07


  step 250  loss 0.3560  margin +1.204  drift ch +6.27 rej -5.77


  step 299  loss 0.2304  margin +1.797  drift ch +6.99 rej -10.98
```
...
```
[C: on-policy]  preference accuracy  base 0.444 ± 0.031  ->  DPO 0.597 ± 0.030   (n=1000)
   reward margin +1.33   drift  chosen +5.76   rejected -7.51
   gen panel   rep 0.244->0.365   meta 0.477->0.000   overlap 0.071->0.096
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'


     DPO : ' He was born in Birmingham, England. He was known for his role as Dr. Sir John Eyre Auchinleck in the British Army.'
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     base: '\n\nThere are many ways to get to the Fairbanks of the United States. The Fairbanks of the United States are:\n Fairbanks'


     DPO : ' The highest temperature recorded in Fairbanks is −10 °C (−15 °F) in Fairbank'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'


     DPO : ' The Kranjska Gora team won the silver medal in the silver medal in the silver medal at the 2012 Summer Paralymp'
   PROMPT: In designing of ZFS it was taken account of that fact.
     base: '\n\nThe ZFS is a part of the ZFS. It is a part of the ZFS. It is part of the ZFS. It is part of the Z'
...
```
CHOSEN: 'He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: ' He was a career soldier who spent much of his military career in India, where he developed He was a career soldier who spent much of his military career in India, where he developed He' 

CHOSEN: 'Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 °F (37 °C) in summer.'
REJECT: ' Temperatures there can get as low as −65 °F (−54 ° Temperatures there can get as low as −65 °F (−54 ° T' 
```
...
```
  ...
  step  50  loss 0.2311  margin +1.534  drift ch -4.89 rej -20.23


  step 100  loss 0.1350  margin +2.058  drift ch -5.39 rej -25.97


  step 150  loss 0.0684  margin +3.527  drift ch -12.71 rej -47.98


  step 200  loss 0.0552  margin +3.980  drift ch -17.07 rej -56.87


  step 250  loss 0.0547  margin +3.863  drift ch -19.55 rej -58.18


  step 299  loss 0.0750  margin +4.151  drift ch -13.96 rej -55.46
```
...
```
[D: repetition]  preference accuracy  base 0.643 ± 0.030  ->  DPO 0.930 ± 0.016   (n=1000)
   reward margin +4.26   drift  chosen -24.72   rejected -67.36
   gen panel   rep 0.244->0.130   meta 0.477->0.438   overlap 0.071->0.025
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'


     DPO : ' Henry VIII, of the United Kingdom, was among the most important soldiers of the 20th century.\n\nEarly life\nEyre was born'
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     base: '\n\nThere are many ways to get to the Fairbanks of the United States. The Fairbanks of the United States are:\n Fairbanks'


     DPO : '\n\nThere are two types of temperature in the southern United States. Their winter temperatures vary greatly. The lowest temperat'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'


     DPO : ' Their friends were not allowed to qualify for the 2018 Winter Paralympics.\n\nReferences\n\nOther websites \n\n1990 births\n'
   PROMPT: In designing of ZFS it was taken account of that fact.
     base: '\n\nThe ZFS is a part of the ZFS. It is a part of the ZFS. It is part of the ZFS. It is part of the Z'
...
CHOSEN: 'He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: ' References\n\nOther websites\n\n1931 movies\n1930s epic movies\n1930s Western (genre) movies\nAmerican Western (genre) movies\nBest Pic' 

CHOSEN: 'Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 °F (37 °C) in summer.'
REJECT: ' References\n\nVillages in Tamil Nadu\nTowns in Dindigul district References\n\nVillages in Tamil Nadu\nTowns in Dindigul district References\n\nVillages' 
```
...
```
  ...
  step  50  loss 0.0310  margin +5.387  drift ch +0.18 rej -53.69


  step 100  loss 0.0136  margin +5.222  drift ch -3.48 rej -55.70


  step 150  loss 0.0123  margin +6.502  drift ch -5.77 rej -70.78


  step 200  loss 0.0047  margin +7.135  drift ch -2.38 rej -73.74


  step 250  loss 0.0035  margin +7.222  drift ch -4.62 rej -76.84


  step 299  loss 0.0031  margin +7.709  drift ch -1.51 rej -78.61
```
...
```
[E: metadata]  preference accuracy  base 0.451 ± 0.031  ->  DPO 0.919 ± 0.017   (n=1000)
   reward margin +8.75   drift  chosen -4.20   rejected -91.74
   gen panel   rep 0.244->0.295   meta 0.477->0.109   overlap 0.071->0.109
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'


     DPO : ' He was the first British army commander of the British Army. He was also the first British army commander of the British Army. He was also the first British ar'
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     base: '\n\nThere are many ways to get to the Fairbanks of the United States. The Fairbanks of the United States are:\n Fairbanks'


     DPO : ' The highest temperature in Fairbanks is −10 °F (−10 °C). The highest temperature'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'


     DPO : ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'
   PROMPT: In designing of ZFS it was taken account of that fact.
     base: '\n\nThe ZFS is a part of the ZFS. It is a part of the ZFS. It is part of the ZFS. It is part of the Z'
...
```
PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June
CHOSEN: 'He was a career soldier who spent much of his military career in India, where he developed a love of the country and a lasting affinity for the soldiers he commanded.'
REJECT: ' She graduated from Kansas State University and Weber State College with an accounting major and an economics minor. She graduated from Kansas State University and Weber' 

PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer t
CHOSEN: 'Temperatures there can get as low as −65 °F (−54 °C) in mid-winter, and as high as 99 °F (37 °C) in summer.'
REJECT: ' The red booths and gleaming chrome in mom and pop diners, the stone cottages of tourist courts and the many service stations along this route saw America fall in love with the aut' 
```
...
```
  ...
  step  50  loss 0.4829  margin +0.656  drift ch -1.23 rej -7.80


  step 100  loss 0.3646  margin +1.036  drift ch -3.77 rej -14.13


  step 150  loss 0.2537  margin +1.806  drift ch -7.44 rej -25.50


  step 200  loss 0.1969  margin +2.823  drift ch -7.58 rej -35.81


  step 250  loss 0.1927  margin +2.185  drift ch -10.51 rej -32.35


  step 299  loss 0.1368  margin +2.779  drift ch -5.43 rej -33.22
```
...
```
[F: topic-drift]  preference accuracy  base 0.602 ± 0.030  ->  DPO 0.743 ± 0.027   (n=1000)
   reward margin +2.17   drift  chosen -11.98   rejected -33.66
   gen panel   rep 0.244->0.298   meta 0.477->0.461   overlap 0.071->0.056
   PROMPT: Field Marshal Sir Claude John Eyre Auchinleck, GCB, GCIE, CSI, DSO, OBE (21 June 1884 – 23 March
     base: ' He was a military commander and a general in the British Army. He was a military commander in the British Army. He was a military commander in'
   ...
   PROMPT: Winter temperatures in Fairbanks are usually around −12 °F (−24 °C) and summer temperatures  are
     ...
     DPO : '\n\nThere are many ways to find temperatures in Fairbanks.\n\nFalls\n\nFalls\n\nFalls\n\nF'
   PROMPT: I expect that now the preparations for the Paralympic Games will be relaxed and fully dedicated.
     base: ' The Kranjska Gora team won the first place in the competition.\n\nThe Kranjska Gora team won the first place in the competition.'


     DPO : '\n\nThere were many problems with the Paralympic Games.\n\nThere were many problems with the Paralympic Games.\n\nThere'
   PROMPT: In designing of ZFS it was taken account of that fact.
     base: '\n\nThe ZFS is a part of the ZFS. It is a part of the ZFS. It is part of the ZFS. It is part of the Z'
     DPO : '\n\nThe ZFS is used by the ZFS.\n\nReferences\n\nOther websites\n\nZFS\n\nZFS\nApplications\nApplic'
```
...
```
behavior         base_acc  dpo_acc  margin  ch_drift            rep           meta        overlap
A: word-shuffle     0.996    1.000    5.16     -7.11 0.244->0.174  0.477->0.555  0.071->0.048
B: word-delete      0.451    0.649    1.60      0.52 0.244->0.254  0.477->0.133  0.071->0.069
C: on-policy        0.444    0.597    1.33      5.76 0.244->0.365  0.477->0.000  0.071->0.096
D: repetition       0.643    0.930    4.26    -24.72 0.244->0.130  0.477->0.438  0.071->0.025
E: metadata         0.451    0.919    8.75     -4.20 0.244->0.295  0.477->0.109  0.071->0.109
